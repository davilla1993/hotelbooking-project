...
export class Paymentpage {
  ...
  clientSecret: any = null; //unique transaction id for every transaction
  error: any = null;
  ...
  async ngOnInit() {
    ...
    this.stripe = await loadStripe(
      'pk_test_51RhdVaBI7RNBzbZeJyE6DoWkdnxnLJCD9NTR3aTbjfxChXabkN7FrHFkpqFfuVhtTkVVvQaZ8IsOOgSh3jLvvoeo00KIc7ptqo'
    );
